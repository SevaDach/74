...
class Polygon(Figure):
    ...
    def __init__(self, a, b, c, treug):
        ...
        self.treug = treug
        self.otv = 0
        if is_in_triangle(a, self.treug) and is_in_triangle(b, self.treug):
            self.otv += 1
        if is_in_triangle(c, self.treug) and is_in_triangle(b, self.treug):
            self.otv += 1
        if is_in_triangle(a, self.treug) and is_in_triangle(c, self.treug):
            self.otv += 1
    ...
    def add(self, t):
        ...
        if t.is_light(self.points.last(), self.points.first()):
            ...
            if is_in_triangle(self.points.last(), self.treug) and\
               is_in_triangle(self.points.first(), self.treug):
                self.otv -= 1
            ...
            while t.is_light(p, self.points.first()):
                ...
                if is_in_triangle(p, self.treug) and\
                   is_in_triangle(self.points.first(), self.treug):
                    self.otv -= 1
            ...
            while t.is_light(self.points.last(), p):
                ...
                if is_in_triangle(p, self.treug) and\
                   is_in_triangle(self.points.last(), self.treug):
                    self.otv -= 1
            ...
            if is_in_triangle(t, self.treug) and\
               is_in_triangle(self.points.first(), self.treug):
                self.otv += 1
            if is_in_triangle(t, self.treug) and\
               is_in_triangle(self.points.last(), self.treug):
